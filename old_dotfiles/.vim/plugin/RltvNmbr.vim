...
"  call Dfunc("RltvNmbr#RltvNmbrCtrl(start=".a:start.")")
  ...
  if      a:start && !exists("s:rltvnmbr_{bufnr('%')}")
   ...
   if !exists("s:rltvnmbr_signs")
	...
	hi default HL_RltvNmbr_Minus	gui=none,italic ctermfg=22   ctermbg=black guifg=22   guibg=black
	hi default HL_RltvNmbr_Positive	gui=none,italic ctermfg=28 ctermbg=black guifg=28 guibg=black
...
"  call Dfunc("s:ColorschemeLoaded()")
	hi HL_RltvNmbr_Minus	ctermfg=22   ctermbg=black guifg=22   guibg=black
	hi HL_RltvNmbr_Positive	ctermfg=28 ctermbg=black guifg=28 guibg=black

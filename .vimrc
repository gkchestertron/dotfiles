...
" set rtp=$VIMRUNTIME,/Users/jfellman/shop/dotfiles/.vim,/Users/jfellman/shop/dotfiles/.vim/bundle/snipmate/after
...
autocmd BufWinEnter *.ejs :set syntax=html
autocmd BufWinEnter *.py :set ts=4 | set sw=4 | set expandtab | set softtabstop=4
autocmd BufWinEnter *.go :set tabstop=2 softtabstop=2 shiftwidth=2 noexpandtab | let g:go_test_timeout= '60s'
autocmd BufWinEnter *.snippets :set noexpandtab
autocmd BufWinEnter *.graphql :set binary | set noeol
